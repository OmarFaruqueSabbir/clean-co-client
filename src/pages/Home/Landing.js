...
import bucketgrl from '../../assets/image/bucketgirl.png'

const Landing = () => {
    return (
        < div className='relative'>
            <div class="hero h-screen lg:h-[60vh] lg:bg-accent  relative z-10 mt-16">
                <div class="hero-content flex-col lg:flex-row">
                    ...
                    <div >
                        ...
                        <p data-aos='fade-right' data-aos-duration='800' data-aos-delay='600' class="py-6 max-w-xl">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has</p>
                        <button data-aos='zoom-in' data-aos-delay='1300' class="btn btn-primary">Get Started</button>
                    </div>
                    <div className='h-[60vh] shrink-0'>
                        <img src={bucketgrl} class="h-full" alt='img' />
                    </div>
                </div>
            </div>
            <div className='rounded-2xl mx-auto mt-[-40px] relative z-20 bg-base-200 shadow-lg p-10 w-5/6'>
